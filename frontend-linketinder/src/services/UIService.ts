...
export class UIService {
    static renderizarVagas(): void {
        ...
        vagas.forEach(vaga => {
            ...
            card.innerHTML = `
                ...
                <p><strong>Localização:</strong> ${empresa?.pais || 'N/A'}, ${empresa?.estado || 'N/A'}</p>
            `;
    ...
    // Listar candidatos para gerenciamento
    ...
    // Listar empresas para gerenciamento
    static listarEmpresas(): void {
        ...
        empresas.forEach(empresa => {
            ...
            item.innerHTML = `
                ...
                <button data-id="${empresa.id}" class="btn-excluir-empresa">Excluir</button>
            `;
            lista.appendChild(item);
        });
    }

    // Listar vagas para gerenciamento
